  ...
  return (
    <footer className="bg-black text-white">
      ...
      <div className="mx-auto max-w-6xl px-4 grid grid-cols-1 md:grid-cols-3 mt-0 md:mt-0 min-h-[80svh] md:min-h-0 flex-col justify-center gap-0 md:gap-0 divide-y divide-white/10 md:divide-y-0 md:divide-x md:divide-white/10">
        ...
        >
          <div className="mb-1 md:mb-2 inline-flex h-8 w-8 md:h-10 md:w-10 items-center justify-center rounded-full bg-neutral-900 text-about-primary group-hover:scale-110 transition-transform border border-white/10">
            <Phone size={18} className="md:w-5 md:h-5" />
          </div>
          <div>
            <h3 className="text-[10px] md:text-xs uppercase tracking-widest text-neutral-500 mb-0.5 md:mb-1">Phone</h3>
            <span className="block text-base md:text-lg font-semibold text-white transition-colors group-hover:text-about-primary">
              +39 345 157 5507
            </span>
          </div>
        </Link>
        ...
        <a
          ...
          className="group py-6 md:py-4 flex flex-col items-center justify-center gap-2 md:gap-3 text-center cursor-pointer flex-1"
        >
          <div className="mb-1 md:mb-2 inline-flex h-8 w-8 md:h-10 md:w-10 items-center justify-center rounded-full bg-neutral-900 text-work-primary group-hover:scale-110 transition-transform border border-white/10">
            <Mail size={18} className="md:w-5 md:h-5" />
          </div>
          <div>
            <h3 className="text-[10px] md:text-xs uppercase tracking-widest text-neutral-500 mb-0.5 md:mb-1">Email</h3>
            <span className="block text-base md:text-lg font-semibold text-white transition-colors group-hover:text-work-primary">
