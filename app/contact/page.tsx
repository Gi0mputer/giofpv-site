...
export default function ContactPage() {
  return (
    <main className="h-[100dvh] min-h-[600px] bg-neutral-950 pt-32 pb-6 px-6 flex flex-col items-center justify-start sm:justify-center relative overflow-hidden">
