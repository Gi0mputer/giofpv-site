...
export default function ContactPage() {
  return (
    <main className="min-h-screen bg-neutral-950 pt-36 pb-12 px-6 lg:pt-24 lg:flex lg:flex-col lg:items-center lg:justify-center lg:p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl space-y-12 relative z-10 text-center">
        ...
        <section className="space-y-4">
          <h1 className="text-3xl sm:text-5xl font-bold tracking-tight text-white">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-sunset-orange via-[#fa991d] via-sunset-amber via-sunset-sky to-sunset-violet">Something Epic</span>
          </h1>
